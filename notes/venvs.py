...
# enviornment with packages.

# To create a virutal environment open a Command Line Interface
...
# To install packages, we need to activate your virtual enviornment. If you look in the 'venv' folder,
...
# Windows: 'venv\Scripts\acitvate.bat'
# Windows PowerShell: 'venv\Scripts\acitvate.ps1'
